// write a function getField(attr) that uses Maybe to safely access obj propertuesm avoiding runtime errors
...
const getField = (attr) => (obj) => Maybe.of(obj).map(o => o[attr]);
